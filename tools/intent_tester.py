...
def print_result_rich(
    ...
    console.print(
        Panel(
            fusion_table,
            title="[bold green]🧠 Fusion Result[/bold green]",
            border_style="green",
        )
    )
    ...
    routing_table.add_row("⚠️  Risk Level", f"[{risk_color}]{risk}[/{risk_color}]")

    console.print(
        Panel(
            routing_table,
            title="[bold yellow]🎯 Agent Routing[/bold yellow]",
            border_style="yellow",
        )
    )
    ...
    if gesture_name and gesture_info:
        ...
        console.print(
            Panel(
                gesture_table,
                title="[bold magenta]✋ Gesture Info[/bold magenta]",
