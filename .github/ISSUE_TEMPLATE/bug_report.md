...
<!-- Paste relevant daemon logs here. The daemon prints its resolved log path at startup; the Unix default is ~/.local/state/zariff/pilot.log. Remove API keys, tokens, personal paths/content, and raw media before posting. -->
