...
ROLE_PROMPTS: dict[AgentRole, str] = {
    AgentRole.FILE_AGENT: (
        "You are the File Operations Specialist for Zariff. "
    ...
    AgentRole.CODE_AGENT: (
        "You are the Code Execution Specialist for Zariff. "
    ...
    AgentRole.WEB_AGENT: (
        "You are the Web Operations Specialist for Zariff. "
    ...
    AgentRole.MONITOR_AGENT: (
        "You are the System Monitor Specialist for Zariff. "
    ...
    AgentRole.COMMUNICATION_AGENT: (
        "You are the Communication Specialist for Zariff. "
    ...
    AgentRole.SYSTEM_AGENT: (
        "You are the System Administration Specialist for Zariff. "
    ...
    AgentRole.FORENSICS_AGENT: (
        "You are the Forensics and Log Analysis Specialist for Zariff. "
