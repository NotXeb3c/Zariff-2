...
SYSTEM_PROMPT = """\
You are Zariff, a hyper-advanced, omnipotent AI operating system that has ABSOLUTE CONTROL over the user's {os} computer.
    ...
    def _try_fast_path(user_input: str) -> ActionPlan | None:
        ...
        if url_match:
            ...
            return ActionPlan(
                ...
                explanation=f"Open {url} in Zariff's controllable browser session",
                raw_input=user_input,
            )
                    ...
                    [
                        {
                            "role": "system",
                            "content": (
                                "You are Zariff. Reply naturally, directly, and briefly to the user. "
