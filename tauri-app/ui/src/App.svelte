        ...
        {#if $session.durableTask && !$session.loading}
          <aside class="task-recovery" aria-live="polite">
            <div>
              ...
              <span>Zariff will continue from its last safe checkpoint without repeating completed actions.</span>
            </div>
                  ...
                  {#if $session.streamingText}
                    <div class="message system streaming">
                      <div class="msg-header">
                        <span class="msg-label">Zariff</span>
...
<style>
  ...
  .window {
    ...
    background:
      linear-gradient(160deg, rgba(0, 229, 255, 0.03), transparent 40%),
      var(--bg-primary);
  ...
  .titlebar {
    ...
    justify-content: space-between;
    padding: 10px 16px;
    background: linear-gradient(90deg, rgba(0, 229, 255, 0.06), rgba(255, 46, 166, 0.04) 60%, transparent);
  ...
  .logo {
    ...
    background: linear-gradient(135deg, #00e5ff, #ff2ea6);
    color: #04121a;
    font-weight: 700;
    font-size: 13px;
    border-radius: var(--radius-sm);
    box-shadow: 0 0 14px rgba(0, 229, 255, 0.5), 0 0 22px rgba(255, 46, 166, 0.3);
  }
  ...
  .empty-logo {
    ...
    align-items: center;
    justify-content: center;
    background: linear-gradient(135deg, #00e5ff, #a06bff, #ff2ea6);
    color: #04121a;
    font-weight: 700;
    font-size: 22px;
    border-radius: 12px;
    margin-bottom: 4px;
    box-shadow: 0 0 20px rgba(0, 229, 255, 0.5), 0 0 36px rgba(255, 46, 166, 0.3);
  }
  ...
  :global(html.light-mode) .empty-state h2 {
    background: none;
    -webkit-background-clip: initial;
    background-clip: initial;
    color: var(--text-primary);
